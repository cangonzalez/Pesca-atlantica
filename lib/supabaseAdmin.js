...
export async function listOrdersForUser(userId) {
  ...
  const { data, error } = await supabase
    .from('orders')
    .select(
      'id, external_reference, mercadopago_preference_id, mercadopago_payment_id, status, status_detail, buyer_name, buyer_email, buyer_phone, delivery_address, delivery_notes, currency, shipping_cost, total_amount, items, payment_method_id, payment_type_id, created_at, updated_at'
    )
